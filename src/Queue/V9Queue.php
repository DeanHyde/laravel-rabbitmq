...
class V9Queue extends Queue implements QueueContract
{
    /**
    ...
    {
        app(LoggerInterface::class)::error('AMQP error while attempting ' . $action . ': ' . $e->getMessage());
